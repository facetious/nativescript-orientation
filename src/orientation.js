    ...
    orientation.getOrientation = function() {
        ...
        switch (device.orientation) {
            ...
            default:
                ...
                if (appOrientation === 1 || appOrientation === 2) { return enums.DeviceOrientation.portrait; } else { return enums.DeviceOrientation.landscape; }
        }
    };
...
var handleNavigatingTo = function(args) {
    ...
    if (targetPage) {
        applyOrientationToPage(targetPage, { force: false });
    }
};
